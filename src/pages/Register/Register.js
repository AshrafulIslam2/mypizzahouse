...
const Register = () => {
  ...
  return (
    <div className="w-full max-w-md mx-auto mt-10 p-4 rounded-md shadow sm:p-8 bg-gray-900 text-gray-100">
      <ToastContainer />
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-3 py-2 border rounded-md border-gray-700 bg-gray-900 text-gray-100 focus:border-blue-400"
            />
          </div>
          <div className="space-y-2">
